...
public class ARCameraViewActivity extends ARActivity {
    ...
    public void setup() {
        ...
        for (CMSTrackable tempTrackable : trackables) {
            addModelNode(tempTrackable);
            setupArbiTrack(tempTrackable);
        }
    }


    private  void addModelNode(CMSTrackable tempTrack) {

        // Import model
        ARModelImporter modelImporter = new ARModelImporter();
        modelImporter.loadFromPath(tempTrack.getAugmentationFilePath());
    ...
    //Sets up arbi track
    public void setupArbiTrack(CMSTrackable tempTrack) {
